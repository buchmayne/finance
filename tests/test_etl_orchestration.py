...
class TestETLPipeline:
    ...
    def test_run_layer_raw_executes_all_functions(
        self, mock_import_cc, mock_import_ba
    ):
    ...
    def test_run_full_pipeline_executes_in_order(
        self,
        mock_spending, mock_savings, mock_income, mock_transactions,
        mock_staging_cc, mock_staging_ba,
        mock_raw_cc, mock_raw_ba
    ):
