...
def plot_monthly_spending_by_category(
    db: Session, period: str = "full_history", include_wedding: bool = True
) -> None:
...
def plot_monthly_budget_history(
    db: Session, period: str = "full_history", include_wedding: bool = False
) -> None:
...
def plot_average_monthly_budget(
    db: Session, period: str = "full_history", include_wedding: bool = True
) -> None:
