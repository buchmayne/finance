...
def main():
    ...
    parser.add_argument("--account-type", choices=["bank_account", "credit_card"], help="Bank type for automatic column mapping")
    parser.add_argument("--preview-only", action="store_true", help="Just preview the file(s)")
    ...
    if path.is_file():
        ...
        try:
            ...
            result = process_single_file(importer, path, args.account_type, args.dry_run)
